        ...
        <div class="bg-white rounded-lg shadow pt-1 pb-2">
            <table class="w-full">
                ...
                <tr class="border-b border-gray-300">
                    ...
                    <th class="text-left px-2 pt-2 pb-2 font-normal text-right">{{ __('Failures') }}</th>
                    <th class="text-left pl-2 pr-6 pt-2 pb-2 font-normal">{{ __('Started at') }}</th>
                    <th class="text-left pl-2 pr-6 pt-2 pb-2 font-normal">{{ __('Last failure at') }}</th>
                </tr>
                </thead>
                ...
                @foreach ($workflows as $workflow)
                    <tr class="text-sm transition duration-300 hover:bg-gray-100 cursor-pointer text-gray-800">
                        ...
                        <td class="pl-2 pr-6 py-2">
                            {{ $workflow->jobs->whereNotNull('failed_at')->sortByDesc('failed_at')->first()->failed_at->format('Y-m-d H:i') }}
                        </td>
                    </tr>
                @endforeach
                </tbody>
